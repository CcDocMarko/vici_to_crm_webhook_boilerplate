...
$emailDateTime = $dateTime->format('m/d/Y H:i');

$to = 'Leads@legacytxroofing.com';

$subject = 'CC Docs - ' . $emailDateTime . ' - ' . $address;

$body = "Lead Generated by CC Docs\n\n";
$body .= "Prospect:\n";
...
$body .= $city . ', ' . $state . ' ' . $postal_code . "\n";
$body .= "Phone: " . $phone . "\n\n";
$body .= "Appointment Info (Custom fields):\n";
$body .= "Date + Time: " . $emailDateTime . "\n";
$body .= "Homeowner: " . $decision_maker . "\n";
$body .= "Roof Type: " . $roof_type . "\n";
$body .= "Roof Age: " . $roof_age . "\n\n";
$body .= "Call Notes:\n" . $additional_notes . "\n";
$body .= "Recording URL:\n" . $actual_recording_url . "\n";
// Headers
$headers = 'From: no-reply@ccdocs.com' . "\r\n" .
	'Reply-To: no-reply@ccdocs.com' . "\r\n" .
	"Cc: rico@legacytxroofing.com\r\n" .
